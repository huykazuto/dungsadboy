...
def slowprint(s):
	for c in s + '\n':
		...
		sys.stdout.flush()
		time.sleep(1./10)
slowprint(Fore.LIGHTBLUE_EX + "Tool Spam Auto Pro Dũng Sad Boy")
time.sleep(1.0)
os.system("cls")
 ...
 |_____/  |_|  |_| |_____/  
    ...
    def run(self):
        while True:
            ...
            if self.phone != '0336898934':
                if len(self.phone) == 10:
                    break
                print(self.format_print("!", "SỐ ĐIỆN THOẠI DƯỚI 10 SỐ NHẬP LẠI ĐI THẰNG ĐẦN !"))
            if self.phone == '0336898934':
                print(self.format_print("!", "LÀM ƠN ĐỪNG SPAM SỐ ĐIỆN THOẠI DŨNG NHÉ^^!"))
            time.sleep(3)
